...
namespace DirectShowLib.Sample
{
    ...
    public class MainForm : Form
    {
        ...
        private MenuItem menuFileOpenClip;
        private MenuItem menuFileClose;
        private MenuItem menuFileExit;
        private MenuItem menuFilePause;
        private MenuItem menuFileStop;
        private MenuItem menuFileMute;
        private MenuItem menuSingleStep;
        private MenuItem menuFileSizeHalf;
        private MenuItem menuFileSizeThreeQuarter;
        private MenuItem menuFileSizeNormal;
        private MenuItem menuFileSizeDouble;
        private MenuItem menuFileFullScreen;
        private MenuItem menuRateIncrease;
        private MenuItem menuRateDecrease;
        private MenuItem menuRateNormal;
        private MenuItem menuRateHalf;
        private MenuItem menuRateDouble;
        ...
        private void InitializeComponent()
        {
            ...
            this.menuFileOpenClip = new MenuItem();
            this.menuFileClose = new MenuItem();
            this.menuItem4 = new MenuItem();
            this.menuFileExit = new MenuItem();
            this.menuItem6 = new MenuItem();
            this.menuFilePause = new MenuItem();
            this.menuFileStop = new MenuItem();
            this.menuFileMute = new MenuItem();
            this.menuItem10 = new MenuItem();
            this.menuSingleStep = new MenuItem();
            this.menuItem12 = new MenuItem();
            this.menuFileSizeHalf = new MenuItem();
            this.menuFileSizeThreeQuarter = new MenuItem();
            this.menuFileSizeNormal = new MenuItem();
            this.menuFileSizeDouble = new MenuItem();
            this.menuItem17 = new MenuItem();
            this.menuFileFullScreen = new MenuItem();
            this.menuItem19 = new MenuItem();
            this.menuRateIncrease = new MenuItem();
            this.menuRateDecrease = new MenuItem();
            this.menuItem22 = new MenuItem();
            this.menuRateNormal = new MenuItem();
            this.menuRateHalf = new MenuItem();
            this.menuRateDouble = new MenuItem();
            ...
            this.menuItem6.MenuItems.AddRange(new MenuItem[] {
                                                                              this.menuFilePause,
                                                                              this.menuFileStop,
                                                                              this.menuFileMute,
                                                                              this.menuItem10,
            ...
            this.menuItem19.MenuItems.AddRange(new MenuItem[] {
        ...
        private void PlayMovieInWindow(string filename)
        {
            ...
            //this.basicAudio = this.graphBuilder as AudioRender;
